---
title: "Number of reads left after DADA2 analysis"
...
#### Data for V1V2,V3V4 and V4V5
```{r}
setwd("C:/Users/Noga/OneDrive - University of Haifa/Noga Phd/Jellyfish_research/16s_analysis/Primer_comparison")
#V1V2
...
#### __Add unclassified sign to missing taxa__ ####
...
```
#### __Filter data and create phyloseq tables__ ####
```{r echo=TRUE, eval=TRUE}
# create a list of ASV and Taxonomy tables
